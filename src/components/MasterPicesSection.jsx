    ...
    <div className="bg-gray-200 w-full">
      <div className="padding flex flex-col gap-10 relative">
        <div className="flex flex-wrap justify-between relative">
          ...
          <span className="text-[18px] text-blue-500 flex gap-1.5 justify-center items-center">
            Discover More Masterpieces <MoveRightIcon />
          </span>
        </div>
        <div className="relative">
          <div className="scrollable-container flex gap-4 overflow-x-hidden max-sm:overflow-auto [scrollbar-width:none] pb-2">
            {masterpieces.map((item, idx) => (
              ...
              >
                ...
                <div className="flex gap-2 p-2">
                  <div>
                    <img className="w-[60px] h-[60px] rounded-full" src={item.dp} alt="" />
                  </div>
                  <div className="p-3">
          ...
          <button
            onClick={scrollRight}
            className="absolute -right-4 top-1/2 transform -translate-y-1/2 bg-white p-2 rounded-full shadow border hover:bg-gray-100 max-sm:hidden"
          >
            <ChevronRight className="w-5 h-5 text-gray-700" />
          </button>
          <button
            onClick={scrollLeft}
            className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-white p-2 rounded-full shadow border hover:bg-gray-100 max-sm:hidden"
          >
